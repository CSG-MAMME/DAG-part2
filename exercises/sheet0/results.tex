...
We can easily, and in a fast manner, access each position shifiting bits, and unions, intersections and complements are solved using bitwise OR, AND, and NOT operators.
The code implemented in \textsc{Python3}, albeit leveraging the same principle, implements the masking operations differently. 
In both cases, COMPLEXITY MISSING HERE>
