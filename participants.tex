...
\begin{center}
  \begin{tabular}[c]{lll}
    ...
    \\\hline
    Lluc Tresserras Pujadas
    & @lluc.tresserras
    & \texttt{lluctrespuj@gmail.com}
    \\\hline
    ...
    & @jordiventura
    & \texttt{jordiventura96@hotmail.com}
    \\\hline
  \end{tabular}
\end{center}
...
\section*{Lluc Tresserras Pujadas}

My name is Lluc Tresserras Pujadas, and I finished my degree in Mathematics at the University of Barcelona (UB).
During the degree I only have used the programming language C, so, I would like to know more about other types
of programming languages. I enjoyed subjects related with dynamical systems and numerical methods, and programming 
to solve problems related to these subjects.

I have not done so many programming projects, all of them in C, and I only have used to solve some problems 
using numerical tools.

I would like to know more about other programming languages and use them to solve diferent types of problems.

In three years I don't know where I will be, but I would like to know more about Mathematics and in particular, 
more about dynamical systems. I also enjoy the subject of models for biology. I would like to do some research, but I also would enjoy working 
somewhere related to these fields. I think that doing the TFM will help me to find a precise objective. 
...
\medskip 
\section*{Jordi Ventura}

My name is Jordi Ventura and I completed a dual degree in Aerospace Engineering and Telecommunications Systems Engineering, at Universitat Politècnica de Catalunya. The math that I studied are rather applied: from basic calculus and algebra to probability and complex analysis. My final thesis, that I completed at University of California Irvine, was about geometric nonlinear control, a topic in which differential geometry plays an important role.
I'm currently doing this graduate studies in order to acquire enough background in the field of Applied Mathematics to continue with a PhD in Mechanical and Aerospace Engineering. I expect from this course to strengthen my programming skills and gain more knowledge of geometry from the algorithmic point of view.
The main software languages that I've worked with are \textsc{Matlab} and \textsc{C}, and I also used \textsc{Python} in the research internship I did during the Bachelor. Occasionally, I've worked with other tools like \textsc{Java}, \textsc{Android} or \textsc{Arduino}.
In 3 years time, I see myself conducting my PhD back in the US. I expect this might take me about 4-5 years and I wish to continue working in research afterwards.
